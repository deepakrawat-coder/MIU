    ...
    <section class="contact-info-style4-area pb-5">
        <div class="container">
            <div class="message border border-1 p-4 rounded-lg text-center">
                ...
                <img src="{{ asset('assets/images/web-image/registrar.jpg') }}"
                    class="img-fluid messageimage border border-info my-4" alt="image">

                <h2> Prof. T. Brajeshwari Devi </h2>
                <h3 class="mt-2 text-info"> Registrar </h3>
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                            ...
                            <div class="message-details-2 border border-1 mt-4 p-4">
                                ...
                                <p class="text-start">Manipur International University, with its campuses spread across the pristine lush green valley and blue hills in the serene environment of the unique valley of Manipur state India, is an ideal place conducive to high quality learning.
                                </p>
                                <p class="text-start">Education and learning, the acquisition of knowledge, skills and values aids the all-round growth of the physical, mental, intellectual and spiritual aspects of an individual, leading to career growth and self-development.
                                </p>
                                <p class="text-start">In the present Hi-tech era and globalization, technology influences occupation, working systems and lifestyle; this situation demands to the individuals a need to prepare for a space in the hi-tech competitive world and tech-savvy skills are a must for advancing their careers in the global marketplace.
                                </p>
                                ...
                                <p class="text-start">MIU emphasizes in inculcating scientific learning, research mindedness, creative thinking, innovations and gaining skills to suit the modern hi-tech era as well as maintain an environment to nurture talent and ignite their minds to facilitate learning with introspection which is enlightening and empowering to elevate them to ideal-character individuals.
                                </p>
                                ...
                                <div class="regards">
                                    ...
                                    <p class="text-start mb-0 font-weight-bold"> Prof. T. Brajeshwari Devi </p>
                                    <p class="text-start mb-0 font-weight-bold"> Registrar </p>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                            <div class="message-details-3 border border-1 mt-4 p-4">
                                <h3 class="text-start mb-3"> About Prof. T. Brajeshwari Devi </h3>

                                <p class="text-start">Prof. T. Brajeshwori Devi is a well accomplished academician with years of experience in holding administrative duty. She is currently serving as Registrar, Manipur International University (MIU). Her ideal role perfectly blends in encouraging research and innovation among students and emphasizes the university's mission to nurture scientific learning, creative thinking, and skill development. Her academic work includes contributions to topics such as the importance of karma yoga in modern times which is published in reputable journals. She has been involved with initiatives like the Manipur Technology Innovation Hub, helping to establish the state as a centre for technological advancements. s.
                                </p>

                                <div class="regards">
                                    <p class="text-start mb-0 font-weight-bold"> Contact Information</p>
                                    <p class="text-start mb-0 font-weight-bold"> Email <a
                                            href="mailto:registrar@miu.edu.in">registrar@miu.edu.in</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
