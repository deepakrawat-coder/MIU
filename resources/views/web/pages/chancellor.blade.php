...
@section('description', 'Chancellor')
                ...
                <ul class="nav nav-pills mb-3 justify-content-center" id="pills-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active border border-1 mr-3" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab"
                            aria-controls="pills-home" aria-selected="true"> Chancellor's Message </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link border border-1" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab"
                            aria-controls="pills-profile" aria-selected="false"> About Chancellor </a>
                    </li>
                </ul>
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        <div class="message-details-2 border border-1 mt-4 p-4">
                            ...
                            <p class="text-start">Being the Chancellor of such a prestigious institution is a great honor. At MIU, we focus on creating an environment where innovation, inclusivity, and excellence guide our actions.</p>
                            ...
                            <div class="regards">
                                ...
                                <p class="text-start mb-0 font-weight-bold"> Chancellor   </p>
                            </div>
                        </div>
                    </div>
