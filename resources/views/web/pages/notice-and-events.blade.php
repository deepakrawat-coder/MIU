                    ...
                    <div class="theme_carousel testimonial-carousel-nine owl-nav-style-one owl-theme owl-carousel"
                                        ...
                                        <div class="meta-info">
                                            <ul>
                                                <li><span class="icon-calendar"></span><a
                                                        href="/notice-and-events-details"> 27 January
                                                        2026 </a></li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="text-holder">
                                    ...
                                    <div class="bottom-box">
                                        ...
                                        <div class="meta-info">
                                            <ul>
                                                <li><span class="icon-calendar"></span><a
                                                        href="/notice-and-events-details"> 03 September
                                                        2025 </a></li>
                                            </ul>
                                        </div>
                                    </div>
                        ...
                        <div class="single-testimonial-style9 p-0">
                            <div class="single-blog-style1">
                                ...
                                <div class="text-holder">
                                    <h3><a href="/notice-and-events-details">Reviving Traditional Utong Ngari
                                            Production</a></h3>
                                    <div class="text pt-0">
                                    ...
                                    <div class="bottom-box">
                                        ...
                                        <div class="meta-info">
                                            <ul>
                                                <li><span class="icon-calendar"></span><a
                                                        href="/notice-and-events-details"> 14 July
                                                        2025 </a></li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="text-holder">
                                    ...
                                    <div class="bottom-box">
                                        ...
                                        <div class="meta-info">
                                            <ul>
                                                <li><span class="icon-calendar"></span><a
                                                        href="/notice-and-events-details"> 07 July
                                                        2025 </a></li>
                                            </ul>
                                        </div>
                                    </div>
                ...
                <div class="single-courses-box-style4 p-3">
                    <div class="single-courses-box-style4__inner">
                        <div class="text-box ml-0">
                            <h3 class="my-2">
                                <a href="#">
                                    Results Declared: BSc (Counselling Psychology & Spiritual Health), MSc (Value
                                    Education & Yoga), MSc (Counselling Psychology & Spiritual Health)
                                </a>
                            </h3>
                            <span class="badge badge-pill badge-success"> Result </span>
                        </div>
