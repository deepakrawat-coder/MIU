    ...
    {{-- <section class="blog-style1-area mb-5">
        <div class="container">
            <div class="sec-title text-start pb-3">
                <h2 class="mb-3"> Event Gallery </h2>
            </div>

            <ul class="nav nav-pills mb-5" id="pills-tab" role="tablist">
                <li class="nav-item mb-2">
                    <a class="nav-link active border border-1 rounded10 ml-3" id="pills-home-tab" data-toggle="pill"
                        href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Highlights of
                        Educational Tour MIU</a>
                </li>
                <li class="nav-item mb-2">
                    <a class="nav-link border border-1 rounded10 ml-3" id="pills-profile-tab" data-toggle="pill"
                        href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">Highlights
                        from the ICCUFP - 2025</a>
                </li>
                <li class="nav-item mb-2">
                    <a class="nav-link border border-1 rounded10 ml-3" id="pills-contact-tab" data-toggle="pill"
                        href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false">Highlights
                        from the Satsang at MIU</a>
                </li>
            </ul>
