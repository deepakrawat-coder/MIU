...
@section('content')
                ...
                <div class="col-xl-12">
                    <div class="inner-content">
                        ...
                        <div class="breadcrumb-menu" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
                            <ul>
                                <li><a href="/">Home</a></li>
                                <li class="active">School of Science</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="program-details-tab-content">
                        ...
                        <div class="program-details-tab-content__inner">
                            ...
                            <div class="program-details-tab-content__text">
                                <div class="sec-title">
                                    <h2>School of Science – Overview</h2>
                                </div>
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <div class="inner-text">
                                            ...
                                            <p>
                                                The School is committed to imparting knowledge in pure and applied sciences,
                                                which form the backbone of scientific innovation and technological progress.
                                                The B.Sc. and M.Sc. programs are designed to equip students with analytical
                                                thinking, research skills, and practical knowledge, enabling them to pursue
                                                careers across multiple scientific domains.
                                            </p>
                                        </div>
                                    </li>
    ...
    <section id="content" class="testimonial-style1-area py-5 bg-white">
        <div class="container">
            <div class="school-tech-content">
                <h3>Empowering Tomorrow’s Scientists</h3>
                <p>
                    The School aims to nurture a new generation of scientific thinkers capable of addressing real-world
                    challenges through innovation and critical reasoning. The programs combine strong theoretical
                    foundations with hands-on experience through laboratory work, field studies, guest lectures, and
                    project-based learning. Students apply scientific concepts to practical challenges in healthcare,
                    agriculture, environmental science, and emerging technologies.
                </p>
                <h3>Real-World Learning, Real Impact</h3>
                <p>Education at MIU goes beyond textbooks by emphasizing experiential learning. Students get opportunities
                    to:</p>
                <ul class="list-style-one">
                    <li>• Perform advanced laboratory work in Microbiology, Molecular Biology, Cell Culture, and Chemistry
                    </li>
                    <li>• Explore interdisciplinary areas such as genetic engineering, bioinformatics, and bioprocessing
                    </li>
                    <li>• Address global challenges through ethical reasoning, critical analysis, and practical skills</li>
                    <li>• Participate in science fairs, seminars, workshops, and innovation challenges</li>

                </ul>

                <h3>Vision</h3>
                <p>
                    To be a center of excellence in basic sciences and biotechnology, inspiring discoveries and sustainable
                    innovations that address global challenges.
                </p>
                <h3>Mission</h3>
                <p>
                    To empower future scientists and researchers through B.Sc. and M.Sc. programs that combine strong
                    theoretical knowledge, practical skills, and research-oriented learning.
                </p>
                <h3>Programs Offered</h3>
                <p>
                    MIU offers B.Sc. and M.Sc. programs in key scientific disciplines:
                </p>
                <ul>
                    <li>Mathematics</li>
                    <li>Physics</li>
                    ...
                    <li>Biotechnology</li>
                    <li>Statistics</li>
                    <li>Life Sciences and related fields</li>
                </ul>

                <h3>Laboratories and Facilities</h3>
                <p>
                    Modern, well-equipped laboratories for Physics, Biochemistry, Molecular Biology, Microbiology, Organic
                    and Inorganic Chemistry, and other core sciences support practical and research-based learning.
                </p>

                <p>
                    The curriculum balances academic rigor with industry relevance, focusing on pure and applied sciences,
                    research, innovation, and skill development to prepare students for higher education and professional
                    careers.
                </p>
                <h3>Courses</h3>
                <p>
                    The B.Sc. and M.Sc. programs are designed to provide high-quality education and interdisciplinary
                    exposure. Students gain hands-on experience in advanced laboratories across disciplines such as Physics,
                    Chemistry, Biotechnology, Microbiology, and Computational Sciences.</p>
                <p>These programs are structured to meet both academic standards and the evolving needs of research
                    institutions and industries. The curriculum integrates core scientific principles with emerging
                    technologies, encouraging teamwork, innovation, and research-oriented thinking.</p>

                <h3>Scope</h3>
                <p>
                    The B.Sc. and M.Sc. programs in Basic Sciences and Biotechnology provide a strong foundation for careers
                    in research, industry, and academia. Students develop a deep understanding of scientific principles
                    while gaining practical and analytical skills.
                </p>
                <p>Key opportunities include:</p>
                <p>
                    • Research in physics, chemistry, biotechnology, and life sciences<br>
                    • Genetic engineering, bioinformatics, and bioprocessing applications<br>
                    • Careers in healthcare, agriculture, environmental science, and biotechnology<br>
                    • Science writing, education, and consultancy roles<br>
                    • Employment in agri-tech, environmental, and biotech industries<br>
                    • Higher studies such as M.Sc., Ph.D., or research fellowships<br>
                    • Entrepreneurship in diagnostics, organic farming, or green technologies
                </p>
    ...
    <section id="arts-department" style="background: #17345a;" class="arts-department-section">
        <div class="container py-5">
            <div class="row mb-5">
                <div class="col-12 text-center">
                    <h2 class="section-title text-white">School of Science</h2>
                    <p class="section-subtitle text-white">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="dept-card">
                        <div class="dept-header">
                            <span class="dept-icon flaticon-microscope"></span>
                            <h3>B.Sc</h3>
                        </div>
                        <div class="dept-body">
                            <span class="tag">6 Semesters</span>
                            <span class="tag">Eligibility: 10+2 (Relevant Subjects)</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="dept-card">
                        ...
                        <div class="dept-body">
                            ...
                            <span class="tag">Eligibility: Graduate (B.Sc)</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="career" class="career-opportunities-area">
        <div class="container">
            <div class="row">
                <div class="col-12 text-center mb-5">
                    <div class="sec-title">
                        ...
                        <p class="sub-title mt-3 text-dark">Graduates from the School of Science can pursue diverse career
                            paths</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    <div class="career-card">
                        ...
                        <h5>Research Scientist / Biotechnologist</h5>
                        {{-- <p class="text-primary mb-3">
                            <i class="fa fa-inr mr-1"></i> 4–12 LPA
                        </p> --}}
                        <p class="text-muted small mb-4">
                            Work in healthcare, agriculture, or environmental research.
                        </p>
                        <div class="skills">
                ...
                <div class="col-md-4 mb-4">
                    <div class="career-card">
                        ...
                        <h5>Clinical Lab Technician / Analyst</h5>
                        {{-- <p class="text-primary mb-3">
                            <i class="fa fa-inr mr-1"></i> 5–15 LPA
                        </p> --}}
                        <p class="text-muted small mb-4">
                            Conduct diagnostic and research activities in hospitals and laboratories.
                        </p>
                        <div class="skills">
                            <span class="badge">Diagnostics</span>
                            <span class="badge">Lab Analysis</span>
                ...
                <div class="col-md-4 mb-4">
                    <div class="career-card">
                        ...
                        <h5>Pharmaceutical Associate</h5>
                        {{-- <p class="text-primary mb-3">
                            <i class="fa fa-inr mr-1"></i> 4–10 LPA
                        </p> --}}
                        <p class="text-muted small mb-4">
                            Contribute to drug development and clinical research.
                        </p>
                        <div class="skills">
                            <span class="badge">Drug Development</span>
                            <span class="badge">Clinical Research</span>
                            <span class="badge">Pharma</span>
                ...
                <div class="col-md-4 mb-4">
                    <div class="career-card">
                        ...
                        <h5>Environmental Scientist</h5>
                        {{-- <p class="text-primary mb-3">
                            <i class="fa fa-inr mr-1"></i> 6–15 LPA
                        </p> --}}
                        <p class="text-muted small mb-4">
                            Work on sustainability and environmental impact projects.
                        </p>
                        <div class="skills">
                            <span class="badge">Sustainability</span>
                            <span class="badge">Environmental Impact</span>
                            <span class="badge">Ecology</span>
                ...
                <div class="col-md-4 mb-4">
                    <div class="career-card">
                        ...
                        <h5>Academic Instructor / Professor</h5>
                        {{-- <p class="text-primary mb-3">
                            <i class="fa fa-inr mr-1"></i> 4–12 LPA
                        </p> --}}
                        <p class="text-muted small mb-4">
                            Teach and mentor future scientists after higher studies.
                        </p>
                        <div class="skills">
            ...
            <div class="row mt-4">
                <div class="col-12">
                    <div class="career-card p-4 text-center">
                        <p class="text-muted mb-0">
                            Graduates can also pursue advanced research, doctoral programs, or launch startups in
                            biotechnology, diagnostics, agriculture, or environmental solutions.
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="course-layout-content-box">
                            ...
                            <ul class="accordion-box">
                                <li class="accordion block active-block">
                                    <div class="acc-btn active">
                                        <div class="course-layout-title-box">
                                            <h4>What science programs are offered at MIU?</h4>
                                    ...
                                    <div class="acc-content current">
                                        <div class="course-layout-content-box-inner">
                                            <p class="p-3">
                                                The School offers B.Sc. (6 Semesters) and M.Sc. (4 Semesters) programs in
                                                key scientific disciplines including Mathematics, Physics, Chemistry,
                                                Biotechnology, Statistics, and Life Sciences.
                                            </p>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="accordion block">
                                    <div class="acc-btn">
                                        <div class="course-layout-title-box">
                                            <h4>What is the eligibility for B.Sc. programs?</h4>
                                            <div class="icon-outer">
                                                <i class="icon-plus"></i>
                                            </div>
                                        </div>
                                    ...
                                    <div class="acc-content">
                                        <div class="course-layout-content-box-inner">
                                            <p class="p-3">
                                                For B.Sc. programs, candidates must have completed 10+2 with relevant
                                                subjects from any recognized board.
                                            </p>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="accordion block">
                                    <div class="acc-btn">
                                        <div class="course-layout-title-box">
                                            <h4>What is the eligibility for M.Sc. programs?</h4>
                                            <div class="icon-outer">
                                                <i class="icon-plus"></i>
                                            </div>
                                        </div>
                                    ...
                                    <div class="acc-content">
                                        <div class="course-layout-content-box-inner">
                                            <p class="p-3">
                                                For M.Sc. programs, candidates must have completed graduation (B.Sc.) in
                                                relevant discipline from any recognized university.
                                            </p>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="accordion block">
                                    <div class="acc-btn">
                                        <div class="course-layout-title-box">
                                            <h4>What career opportunities are available for science graduates?</h4>
                                            <div class="icon-outer">
                                                <i class="icon-plus"></i>
                                            </div>
                                        </div>
                                    ...
                                    <div class="acc-content">
                                        <div class="course-layout-content-box-inner">
                                            <p class="p-3">
                                                Graduates can pursue careers as Research Scientist/Biotechnologist, Clinical
                                                Lab Technician/Analyst, Pharmaceutical Associate, Environmental Scientist,
                                                or Academic Instructor/Professor. Opportunities exist in healthcare,
                                                agriculture, environmental research, drug development, and diagnostics.
                                            </p>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="accordion block">
                                    <div class="acc-btn">
                                        <div class="course-layout-title-box">
                                            <h4>What facilities are available for science students?</h4>
                                            <div class="icon-outer">
                                                <i class="icon-plus"></i>
                                            </div>
                                        </div>
                                    ...
                                    <div class="acc-content">
                                        <div class="course-layout-content-box-inner">
                                            <p class="p-3">
                                                The School has modern, well-equipped laboratories for Physics, Biochemistry,
                                                Molecular Biology, Microbiology, Organic and Inorganic Chemistry. Students
                                                get hands-on experience in advanced lab work, field studies, and
