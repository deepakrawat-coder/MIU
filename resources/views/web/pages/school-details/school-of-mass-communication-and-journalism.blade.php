...
@section('content')
                ...
                <div class="col-xl-12">
                    <div class="inner-content">
                        <div class="title" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1500">
                            <h2>School of Mass Communication and Journalism </h2>
                        </div>
                        <div class="breadcrumb-menu" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
                            <ul>
                                <li><a href="/">Home</a></li>
                                <li class="active">School of Mass Communication and Journalism </li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="program-details-tab-content">
                        ...
                        <div class="program-details-tab-content__inner">
                            ...
                            <div class="program-details-tab-content__text">
                                <div class="sec-title">
                                    <h2>School of Mass Communication and Journalism – Overview</h2>
                                </div>

                                <p>
                                    The School of Journalism and Mass Communication at Manipur International University
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <div class="inner-text">
                                            ...
                                            <p>
                                                With the rapid growth of digital platforms and multimedia communication, the
                                                programs focus on developing skilled communicators who can inform,
                                                influence, and inspire society. Students gain hands-on experience in news
                                                writing, reporting, content creation, video production, media ethics, and
                                                communication strategies. The School provides a creative and professional
                                                learning environment that nurtures critical thinking, storytelling skills,
                                                and media literacy.
                                            </p>
                                        </div>
                                    </li>
    ...
    <section id="content" class="testimonial-style1-area py-5 bg-white">
        <div class="container">
            <div class="school-tech-content">
                ...
                <p>
                    The School aims to create competent, ethical, and technologically proficient information professionals
                    who can contribute to education, research, and knowledge societies.
                </p>
                ...
                <h3>Vision</h3>
                <p>
                    To be a leading center for journalism and mass communication education, producing ethical, creative, and
                    socially responsible media professionals.
                </p>

                <h3>Mission</h3>
                <p>
                    To provide quality education in journalism and mass communication through B.J.M.C. and M.J.M.C. programs
                    that combine academic knowledge, practical skills, industry exposure, and ethical values.
                </p>

                <h3>Programs Offered</h3>
                <ul>
                    <li>Bachelor of Journalism and Mass Communication (B.J.M.C.)</li>
                    <li>Master of Journalism and Mass Communication (M.J.M.C.)</li>
                </ul>
                <p>
                    These programs equip students with a strong understanding of media practices, communication theories,
                    and emerging digital technologies.
                </p>

                <h3>Facilities and Learning Environment</h3>
                <ul>
                    <li>Media and communication labs</li>
                    <li>Audio and video production studios</li>
                    <li>Editing and content creation facilities</li>
                    <li>Workshops, seminars, and guest lectures by media professionals</li>
                    <li>Opportunities for internships and field projects</li>
                </ul>

                <h3>Courses</h3>
                <p>
                    The B.J.M.C. and M.J.M.C. programs provide comprehensive training in various areas of journalism and
                    communication. The curriculum includes:
                </p>
                <ul>
                    <li>News reporting and writing</li>
                    <li>Media ethics and laws</li>
                    <li>Print, electronic, and digital journalism</li>
                    <li>Advertising and public relations</li>
                    <li>Radio and television production</li>
                    <li>Digital media and content creation</li>
                    <li>Communication theories and research</li>
                    <li>Media management</li>
                    <li>Research methodology and dissertation (for M.J.M.C.)</li>
                </ul>
                <p>
                    The programs emphasize practical learning, creativity, critical analysis, and effective communication
                    skills required in modern media industries.
                </p>

                <h3>Scope</h3>
                <p>
                    Graduates of B.J.M.C. and M.J.M.C. programs have wide-ranging opportunities in traditional and digital
                    media sectors. With the expansion of online platforms, content creation, and corporate communication,
                    skilled media professionals are in high demand.
                </p>
                <p>
                    Key opportunities include:
                </p>
                <ul>
                    <li>Journalism in print, television, and digital media</li>
    ...
    <section id="arts-department" style="background: #17345a;" class="arts-department-section">
        <div class="container py-5">
            <div class="row mb-5">
                <div class="col-12 text-center">
                    <h2 class="section-title text-white">School of Mass Communication and Journalism</h2>
                    <p class="section-subtitle text-white">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="dept-card">
                        <div class="dept-header">
                            <span class="dept-icon flaticon-news"></span>
                            <h3>BJMC</h3>
                        </div>
                        <div class="dept-body">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="dept-card">
                        ...
                        <div class="dept-body">
                            ...
                            <span class="tag">Eligibility: BJMC</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12 text-center mb-5">
                    <div class="sec-title">
                        ...
                        <p class="sub-title mt-3 text-dark">Graduates from the School of Mass Communication and Journalism
                            can pursue diverse career paths</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    <div class="career-card">
                        ...
                        <h5>Journalist / Reporter</h5>
                        {{-- <p class="text-primary mb-3">
                            <i class="fa fa-inr mr-1"></i> 4–12 LPA
                        </p> --}}
                        <p class="text-muted small mb-4">
                            Work in newspapers, news channels, or digital media platforms.
                        </p>
                        <div class="skills">
                            <span class="badge">Reporting</span>
                            <span class="badge">News Writing</span>
                            <span class="badge">Investigative Skills</span>
                            <span class="badge">Media Ethics</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="career-card">
                        ...
                        <h5>Content Creator / Digital Media Specialist</h5>
                        {{-- <p class="text-primary mb-3">
                            <i class="fa fa-inr mr-1"></i> 5–15 LPA
                        </p> --}}
                        <p class="text-muted small mb-4">
                            Create engaging content for online platforms and brands.
                        </p>
                        <div class="skills">
                            <span class="badge">Content Writing</span>
                ...
                <div class="col-md-4 mb-4">
                    <div class="career-card">
                        ...
                        <h5>Public Relations Executive</h5>
                        {{-- <p class="text-primary mb-3">
                            <i class="fa fa-inr mr-1"></i> 4–10 LPA
                        </p> --}}
                        <p class="text-muted small mb-4">
                            Manage communication and brand image for organizations.
                        </p>
                        <div class="skills">
                            <span class="badge">PR Strategy</span>
                            <span class="badge">Media Relations</span>
                            <span class="badge">Brand Communication</span>
                            <span class="badge">Crisis Management</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="career-card">
                        ...
                        <h5>Radio or TV Producer</h5>
                        {{-- <p class="text-primary mb-3">
                            <i class="fa fa-inr mr-1"></i> 6–15 LPA
                        </p> --}}
                        <p class="text-muted small mb-4">
                            Produce programs for broadcast and digital channels.
                        </p>
                        <div class="skills">
                            <span class="badge">Production</span>
                            <span class="badge">Broadcasting</span>
                            <span class="badge">Script Writing</span>
                ...
                <div class="col-md-4 mb-4">
                    <div class="career-card">
                        ...
                        <h5>Media Researcher / Academic Instructor</h5>
                        {{-- <p class="text-primary mb-3">
                            <i class="fa fa-inr mr-1"></i> 4–12 LPA
                        </p> --}}
                        <p class="text-muted small mb-4">
                            Pursue higher studies and build careers in research and teaching.
                        </p>
                        <div class="skills">
                            <span class="badge">Media Research</span>
                ...
                <div class="col-12">
                    <div class="career-card p-4 text-center">
                        <p class="text-muted mb-0">
                            Through the B.J.M.C. and M.J.M.C. programs, MIU prepares students to become responsible,
                            creative, and industry-ready media professionals capable of thriving in the evolving world of
                            communication.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="course-curriculum-content-box">
                        <div class="course-layout-content-box">
                            <div class="inner-title">
                                <h4>FAQs</h4>
                                <p>School of Mass Communication and Journalism</p>
                            </div>
                            <ul class="accordion-box">
                                <li class="accordion block active-block">
                                    <div class="acc-btn active">
                                        <div class="course-layout-title-box">
                                            <h4>What journalism programs are offered at MIU?</h4>
                                    ...
                                    <div class="acc-content current">
                                        <div class="course-layout-content-box-inner">
                                            <p class="p-3">
                                                The School offers Bachelor of Journalism and Mass Communication (BJMC) of 6
                                                Semesters and Master of Journalism and Mass Communication (MJMC) of 4
                                                Semesters. These programs combine theoretical foundations with practical
                                                training in journalism, digital media, broadcasting, advertising, and public
                                                relations.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <li class="accordion block">
                                    <div class="acc-btn">
                                        <div class="course-layout-title-box">
                                            <h4>What is the eligibility for BJMC?</h4>
                                            <div class="icon-outer">
                                                <i class="icon-plus"></i>
                                            </div>
                                        </div>
                                    ...
                                    <div class="acc-content">
                                        <div class="course-layout-content-box-inner">
                                            <p class="p-3">
                                                For BJMC (Bachelor of Journalism and Mass Communication), candidates must
                                                have completed 10+2 from any recognized board.
                                            </p>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="accordion block">
                                    <div class="acc-btn">
                                        <div class="course-layout-title-box">
                                            <h4>What is the eligibility for MJMC?</h4>
                                            <div class="icon-outer">
                                                <i class="icon-plus"></i>
                                            </div>
                                        </div>
                                    ...
                                    <div class="acc-content">
                                        <div class="course-layout-content-box-inner">
                                            <p class="p-3">
                                                For MJMC (Master of Journalism and Mass Communication), candidates must have
                                                completed BJMC or equivalent from any recognized university.
                                            </p>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="accordion block">
                                    <div class="acc-btn">
                                        <div class="course-layout-title-box">
                                            <h4>What facilities are available for journalism students?</h4>
                                            <div class="icon-outer">
                                                <i class="icon-plus"></i>
                                            </div>
                                        </div>
                                    ...
                                    <div class="acc-content">
                                        <div class="course-layout-content-box-inner">
                                            <p class="p-3">
                                                The School offers media and communication labs, audio and video production
                                                studios, editing and content creation facilities, workshops and guest
                                                lectures by media professionals, and opportunities for internships and field
                                                projects.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <li class="accordion block">
                                    <div class="acc-btn">
                                        <div class="course-layout-title-box">
                                            <h4>What career opportunities are available for journalism graduates?</h4>
                                            <div class="icon-outer">
                                                <i class="icon-plus"></i>
                                            </div>
                                        </div>
                                    ...
                                    <div class="acc-content">
                                        <div class="course-layout-content-box-inner">
                                            <p class="p-3">
                                                Graduates can pursue careers as Journalist/Reporter, Content Creator/Digital
                                                Media Specialist, Public Relations Executive, Radio or TV Producer, or Media
                                                Researcher/Academic Instructor. Opportunities exist in print, television,
                                                digital media, advertising, corporate communication, and social media
                                                management.
                                            </p>
                                        </div>
                                    </div>
