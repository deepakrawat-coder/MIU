                ...
                <div class="dropdown features-dropdown">
                    ...
                    <div class="dropdown-menu">
                            ...
                            <div class="hstack gap-2 overflow-hidden">
                                <div class="flex-shrink-0">
                                    <img class="img-fluid avatar-sm avatar-item"
                                        src="admin/assets/images/avatar/avatar-10.jpg" alt="avatar image">
                                </div>
                                <div class="flex-grow-1 text-truncate">
                        ...
                        <div class="dropdown-item">
                            <div class="hstack gap-2 overflow-hidden">
                                <div class="flex-shrink-0">
                                    <img class="img-fluid avatar-sm avatar-item" src="admin/assets/images/avatar/avatar-1.jpg"
                                        alt="avatar image">
                                </div>
                                <div class="flex-grow-1 text-truncate">
                            ...
                            <div class="card mb-0">
                                ...
                                <div class="header-cart-scrollable card-body px-0 py-2" data-simplebar="">
                                    ...
                                    <div class="dropdown-item d-flex align-items-center gap-3 py-2">
                                        <img src="admin/assets/images/product/product-3.jpg"
                                            class="img-fluid rounded-3 avatar-lg" loading="lazy"
                                            alt="SoundMaster Wireless Headphones">
                                        <div class="flex-grow-1 text-truncate">
                                            <a href="apps-product-details.html"
                                                class="text-body fw-semibold">SoundMaster Wireless Headphones</a>
                                    ...
                                    <!-- Cart Item 2 -->
                                    <div class="dropdown-item d-flex align-items-center gap-3 py-2">
                                        <img src="admin/assets/images/product/product-4.jpg"
                                            class="img-fluid rounded-3 avatar-lg" loading="lazy" alt="Cocooil Body Oil">
                                        <div class="flex-grow-1 text-truncate">
                                            <a href="apps-product-details.html" class="text-body fw-semibold">Cocooil
                                                Body Oil</a>
                                    ...
                                    <!-- Cart Item 3 -->
                                    <div class="dropdown-item d-flex align-items-center gap-3 py-2">
                                        <img src="admin/assets/images/product/product-6.jpg"
                                            class="img-fluid rounded-3 avatar-lg" loading="lazy"
                                            alt="Luxury Sunglasses">
                                        <div class="flex-grow-1 text-truncate">
                                            <a href="apps-product-details.html" class="text-body fw-semibold">Luxury
                                                Sunglasses</a>
                                ...
                                <div class="card-footer border-top">
                                    ...
                                    <a href="apps-product-checkout.html"
                        ...
                        <div class="dropdown-menu dropdown-menu-lg p-0 dropdown-menu-end">
                            <div class="card shadow-none mb-0 border-0">
                                ...
                                <div class="card-body px-3">
                                    <div class="row g-0">
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="../apps-calendar.html">
                                        ...
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="../apps-tasks-kanban.html">
                                                <div class="avatar border-0 avatar-item bg-light mx-auto mb-2">
                                        ...
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="../apps-todo.html">
                                                <div class="avatar border-0 avatar-item bg-light mx-auto mb-2">
                                    ...
                                    <div class="row g-0">
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="../apps-chat.html">
                                                <div class="avatar border-0 avatar-item bg-light mx-auto mb-2">
                                        ...
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="../apps-email-list.html">
                                                <div class="avatar border-0 avatar-item bg-light mx-auto mb-2">
                    ...
                    <div class="dropdown features-dropdown" id="language-dropdown">
                        <a href="#!" class="btn icon-btn btn-text-primary rounded-circle" data-bs-toggle="dropdown"
                            ...
                            <div class="avatar-item avatar-xs">
                                <img class="img-fluid avatar-xs" src="admin/assets/images/flags/us.svg" loading="lazy"
                                    alt="avatar image">
                            </div>
                        </a>
                        ...
                        <div class="dropdown-menu header-language-scrollable dropdown-menu-end" data-simplebar="">
                            ...
                            <a href="#!" class="dropdown-item py-2">
                                <img src="admin/assets/images/flags/us.svg" alt="en" loading="lazy"
                                    class="me-2 rounded h-20px w-20px img-fluid object-fit-cover">
                                <span class="align-middle">English</span>
                            </a>

                            <a href="#!" class="dropdown-item">
                                <img src="admin/assets/images/flags/es.svg" alt="es" loading="lazy"
                                    class="me-2 rounded h-20px w-20px img-fluid object-fit-cover">
                                <span class="align-middle">Spanish</span>
                            </a>

                            <a href="#!" class="dropdown-item">
                                <img src="admin/assets/images/flags/fr.svg" alt="fr" loading="lazy"
                                    class="me-2 rounded h-20px w-20px img-fluid object-fit-cover">
                                <span class="align-middle">French</span>
                            </a>

                            <a href="#!" class="dropdown-item">
                                <img src="admin/assets/images/flags/ru.svg" alt="ru" loading="lazy"
                                    class="me-2 rounded h-20px w-20px img-fluid object-fit-cover">
                                <span class="align-middle">Russian</span>
                            </a>

                            <a href="#!" class="dropdown-item">
                                <img src="admin/assets/images/flags/de.svg" alt="de" loading="lazy"
                                    class="me-2 rounded h-20px w-20px img-fluid object-fit-cover">
                                <span class="align-middle">German</span>
                            </a>

                            <a href="#!" class="dropdown-item">
                                <img src="admin/assets/images/flags/it.svg" alt="it" loading="lazy"
                                    class="me-2 rounded h-20px w-20px img-fluid object-fit-cover">
                                <span class="align-middle">Italian</span>
                            </a>

                            <a href="#!" class="dropdown-item">
                                <img src="admin/assets/images/flags/zh.svg" alt="zh" loading="lazy"
                                    class="me-2 rounded h-20px w-20px img-fluid object-fit-cover">
                                <span class="align-middle">Chinese</span>
                            </a>

                            <a href="#!" class="dropdown-item">
                                <img src="admin/assets/images/flags/ar.svg" alt="ar" loading="lazy"
                                    class="me-2 rounded h-20px w-20px img-fluid object-fit-cover">
                                    ...
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 me-3">
                                            <div class="avatar-item avatar">
                                                <img class="img-fluid avatar" src="admin/assets/images/avatar/avatar-9.jpg"
                                                    alt="avatar image">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <li class="list-group-item list-group-item-action border-start-0 border-end-0">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 me-3 position-relative">
                                            <div class="avatar-item avatar">
                                                <img class="img-fluid avatar" src="admin/assets/images/avatar/avatar-6.jpg"
                                                    alt="avatar image">
                                            </div>
                                            <span
                    ...
                    <button type="button" id="accountNavbarDropdown"
                        ...
                        <span class="position-relative">
                            {{-- <span class="avatar-item avatar overflow-hidden">
                                <img class="img-fluid" src="admin/assets/images/avatar/avatar-1.jpg" alt="avatar image">
                        ...
                        <span>
                            <span class="h6 d-none d-xl-inline-block text-start fw-semibold mb-0">{{ Auth::user()->name
                                }}
                            </span>
