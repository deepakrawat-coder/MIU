        ...
        <ul class="main-menu" id="all-menu-items" role="menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu" role="menu">
                    ...
                    <li class="slide">
                        ...
                        <ul class="slide-menu" role="menu">
                            <li class="slide">
                                <a href="pages-profile-edit-overview.html" class="side-menu__item" role="menuitem"
                                    data-lang="hr-profile-setting-overview">Overview</a>
                            </li>
                            <li class="slide">
                                <a href="pages-profile-edit-security.html" class="side-menu__item" role="menuitem"
                                    data-lang="hr-profile-setting-security">Security</a>
                            </li>
                            <li class="slide">
                                <a href="pages-profile-edit-billing-plans.html" class="side-menu__item" role="menuitem"
                                    data-lang="hr-profile-setting-billing">Billing & Plans</a>
                            </li>
                            <li class="slide">
                                <a href="pages-profile-edit-notifications.html" class="side-menu__item" role="menuitem"
                                    data-lang="hr-profile-setting-notifications">Notifications</a>
                            </li>
                            <li class="slide">
                                <a href="pages-profile-edit-connections.html" class="side-menu__item" role="menuitem"
                                    data-lang="hr-profile-setting-connections">Connections</a>
                            </li>
                        </ul>
                    </li>
                    <li class="slide">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu" role="menu">
                    ...
                    <li class="slide">
                        <a href="ui-list.html" class="side-menu__item" role="menuitem" data-lang="hr-ui-list">List
                            Group</a>
                    </li>
                    <li class="slide">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu" role="menu">
                    <li class="slide">
                        <a href="icons-remix.html" class="side-menu__item" role="menuitem" data-lang="hr-remix">Remix
                            Icons</a>
                    </li>
                    <li class="slide">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu" role="menu">
                    ...
                    <li class="slide">
                        ...
                        <ul class="slide-menu" role="menu">
                            <li class="slide">
                                <a href="#!" class="side-menu__item" role="menuitem" data-lang="hr-level-3-1">Level
                                    3.1</a>
                            </li>
                            <li class="slide">
                                <a href="#!" class="side-menu__item" role="menuitem" data-lang="hr-level-3-2">Level
                                    3.2</a>
                            </li>
                        </ul>
                    </li>
                    <li class="slide">
                        ...
                        <ul class="slide-menu" role="menu">
                            <li class="slide">
                                <a href="#!" class="side-menu__item" role="menuitem" data-lang="hr-level-3-3">Level
                                    3.3</a>
                            </li>
                            <li class="slide">
                                <a href="#!" class="side-menu__item" role="menuitem" data-lang="hr-level-3-4">Level
                                    3.4</a>
                            </li>
                        </ul>
                    </li>
