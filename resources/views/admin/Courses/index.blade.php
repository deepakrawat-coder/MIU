        ...
        <div class="row g-4">
            <div class="col-12">
                <div class="card mb-0 h-100">
                    <div class="card-body">
                        <table id="courses-table" class="table table-hover align-middle table-nowrap w-100">
...
$(function() {
    ...
    const addButton = {
        ...
        attr: { 'onclick': "add('{{ route('courses.create') }}', 'modal-lg')" }
    };
                ...
                render: function(data,type,full){
                    ...
                    return `<div class="form-check form-switch form-switch-success">
                        <input class="form-check-input" type="checkbox" ${checked}
                            onclick="updateActiveStatus('courses/status/${full.id}','courses-table')">
            ...
            // ✅ Action Buttons
            {
                ...
                render:function(data,type,full){
                    return `<div class="hstack gap-2">
                        ...
                        <button class="btn btn-sm btn-light-danger" onclick="destroy('courses/${full.id}','courses-table')">
